...
**code** | [**\BankIO\Sdk\Model\MessageCode409PIIS**](MessageCode409PIIS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error409PIISAdditionalErrors[]**](Error409PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
