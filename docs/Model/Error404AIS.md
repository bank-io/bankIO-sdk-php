...
**code** | [**\BankIO\Sdk\Model\MessageCode404AIS**](MessageCode404AIS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error404AISAdditionalErrors[]**](Error404AISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
