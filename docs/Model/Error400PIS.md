...
**code** | [**\BankIO\Sdk\Model\MessageCode400PIS**](MessageCode400PIS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error400PISAdditionalErrors[]**](Error400PISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
