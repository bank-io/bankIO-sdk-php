...
**additional_errors** | [**\BankIO\Sdk\Model\Error409PISAdditionalErrors[]**](Error409PISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
