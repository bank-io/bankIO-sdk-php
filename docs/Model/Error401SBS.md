...
**code** | [**\BankIO\Sdk\Model\MessageCode401SBS**](MessageCode401SBS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error401SBSAdditionalErrors[]**](Error401SBSAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
