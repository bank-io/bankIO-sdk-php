...
**code** | [**\BankIO\Sdk\Model\MessageCode404SBS**](MessageCode404SBS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error404SBSAdditionalErrors[]**](Error404SBSAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
