...
**additional_errors** | [**\BankIO\Sdk\Model\Error405PISCANCAdditionalErrors[]**](Error405PISCANCAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
