...
**code** | [**\BankIO\Sdk\Model\MessageCode404PIS**](MessageCode404PIS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error404PISAdditionalErrors[]**](Error404PISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
