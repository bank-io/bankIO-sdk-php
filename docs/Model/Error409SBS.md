...
**code** | [**\BankIO\Sdk\Model\MessageCode409SBS**](MessageCode409SBS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error409SBSAdditionalErrors[]**](Error409SBSAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
