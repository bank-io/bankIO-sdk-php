...
**code** | [**\BankIO\Sdk\Model\MessageCode405PIIS**](MessageCode405PIIS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error405PIISAdditionalErrors[]**](Error405PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
