...
**code** | [**\BankIO\Sdk\Model\MessageCode409AIS**](MessageCode409AIS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error409AISAdditionalErrors[]**](Error409AISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
