...
**additional_errors** | [**\BankIO\Sdk\Model\Error429AISAdditionalErrors[]**](Error429AISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
