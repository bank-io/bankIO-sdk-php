...
**code** | [**\BankIO\Sdk\Model\MessageCode400SBS**](MessageCode400SBS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error400SBSAdditionalErrors[]**](Error400SBSAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
