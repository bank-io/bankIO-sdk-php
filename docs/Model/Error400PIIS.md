...
**code** | [**\BankIO\Sdk\Model\MessageCode400PIIS**](MessageCode400PIIS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error400PIISAdditionalErrors[]**](Error400PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
