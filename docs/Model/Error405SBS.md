...
**code** | [**\BankIO\Sdk\Model\MessageCode405SBS**](MessageCode405SBS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error405SBSAdditionalErrors[]**](Error405SBSAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
