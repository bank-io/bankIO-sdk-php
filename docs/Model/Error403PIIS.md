...
**code** | [**\BankIO\Sdk\Model\MessageCode403PIIS**](MessageCode403PIIS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error403PIISAdditionalErrors[]**](Error403PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
