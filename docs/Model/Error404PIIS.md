...
**additional_errors** | [**\BankIO\Sdk\Model\Error404PIISAdditionalErrors[]**](Error404PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
