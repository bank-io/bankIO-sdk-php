...
**additional_errors** | [**\BankIO\Sdk\Model\Error401PIISAdditionalErrors[]**](Error401PIISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
