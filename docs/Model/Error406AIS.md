...
**code** | [**\BankIO\Sdk\Model\MessageCode406AIS**](MessageCode406AIS.md) |  | 
**additional_errors** | [**\BankIO\Sdk\Model\Error406AISAdditionalErrors[]**](Error406AISAdditionalErrors.md) | Array of Error Information Blocks.  Might be used if more than one error is to be communicated | [optional] 
